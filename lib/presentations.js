...
// FIXME: check every VC's proofs again allow list from `config`
// FIXME: always call `sign()` even if not signing -- and allow
// `null` signature suite to be used to just remove VC proofs that aren't
// allowed and then not sign the presentation
