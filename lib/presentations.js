...
async function _deriveCredentials({vprQuery, matches}) {
  ...
  // FIXME: `match.privacyRating` or similar might also be useful; need to
  // signal to UIs selective disclosure (data minimization) and
  // unlinkability likelihood -- also unlinkability for verifiers vs.
  // for regulators and similar for well-known VC types vs. via proof types
}
