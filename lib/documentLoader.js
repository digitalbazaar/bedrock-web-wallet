...
const loader = securityLoader({
  cache: new LruCache({max: 100, ttl: 5000, updateAgeOnGet: false})
});
loader.addDocuments({
  documents: [
    ...ageContexts,
    ...diContexts,
    // ed25519 2018 context is supported only for signing VPs that have VCs
    // with proofs that require it; it is not used for generating 2018 proofs
    ...ed255192018Contexts
  ]
});
