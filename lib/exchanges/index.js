...
// FIXME: expose API to create a `ClientInteraction` instance from a CHAPI
// event
// FIXME: enable `start()` to take `interaction`, a `ClientInteraction`
// instance instead of a CHAPI event
